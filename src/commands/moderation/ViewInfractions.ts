...
export default class ViewWarns extends BaseCommand {
    ...
    public async run(client: BaseClient, message: Message, args: Array<string>) {
        ...
        const embed = new MessageEmbed()
            ...
            .setColor("RED")
            .addField(`Case #${infractions[page].caseId} - Infraction Type: ${infractions[page].infractionType}`, `${infractions[page].description}`)
            .setFooter(`Page: 1/${infractions.length} - Issued `)
